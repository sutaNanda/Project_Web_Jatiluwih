    ...
    <section>
        <div class="w-full h-full p-2 flex justify-center flex-col mt-20">
            ...
            <div class="w-full h-full flex items-center justify-evenly mt-10">
                ...
                <div class="w-full max-w-72 bg-white border border-gray-200 rounded-lg shadow-sm">
                    <a href="#">
                        <img class="p-8 rounded-t-lg" src="{{ asset('img/img-5.jpg') }}" alt="product image" />
                    </a>
                    <div class="px-5 pb-5">
                        <a href="#">
                            <h5 class="text-xl font-semibold tracking-tight text-gray-900">Terasering Jatiluwih</h5>
                        </a>
