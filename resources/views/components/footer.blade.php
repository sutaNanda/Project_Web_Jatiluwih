    <footer class="bg-green-800 mt-20 md:mt-32 px-4 pb-5">
        <div class="mx-auto w-full max-w-screen-xl p-2 py-4 lg:py-8">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0 ">
                    <a href="" class="flex items-center flex-wrap md:w-96">
                        ...
                        <p class="text-white text-xs text-justify mt-2 md:text-sm">Website Jatiluwih ini merupakan hasil dari proyek yang dibuat semata-mata untuk memenuhi tugas mata kuliah Pemrograman Web II. Seluruh konten, gambar, data, serta fitur yang ditampilkan di dalam website ini bertujuan untuk keperluan akademik dan pembelajaran. Website ini tidak digunakan untuk tujuan komersial, promosi, ataupun transaksi nyata, serta tidak mewakili pihak resmi dari Desa Wisata Jatiluwih.</p>
                    </a>
                </div>

                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 ">
                    <div>
                        <h2 class="mb-1.5 md:mb-6 text-sm font-semibold text-white uppercase">Menu</h2>
                        <ul class="text-gray-300 font-normal">
                            <li class="mb-0 md:mb-2"><a href="/home" class="hover:underline">Beranda</a></li>

                            <li class="mb-0 md:mb-2"><a href="/destinasi" class="hover:underline">Destinasi</a></li>

                            <li class="mb-0 md:mb-2"><a href="/berita" class="hover:underline">Berita</a></li>

                            <li class="mb-0 md:mb-2"><a href="/profil" class="hover:underline">Profil Desa</a></li>

                            <li class="mb-0 md:mb-2"><a href="/kontak" class="hover:underline">Kontak Kami</a></li>
                    ...
                    <div>
                        <h2 class="mb-1.5 md:mb-6 text-sm font-semibold text-white uppercase">Media Sosial</h2>
                        <ul class="text-gray-300 font-normal">
                    ...
                    <div>
                        <h2 class="mb-1.5 md:mb-6 text-sm font-semibold text-white uppercase">Kontak</h2>
                        <ul class="text-gray-300 font-medium">
                            <li class="mb-1.5 md:mb-4 flex gap-2 items-center">
                                ...
                                <p class="text-sm flex items-center">+62 877-8883-7494</p>
