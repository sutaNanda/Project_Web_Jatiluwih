    <footer class="bg-green-800 mt-32">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul class="text-gray-300 font-normal">
                        <li class="mb-2"><a href="/home" class="hover:underline">Beranda</a></li>

                        <li class="mb-2"><a href="/destinasi" class="hover:underline">Destinasi</a></li>

                        <li class="mb-2"><a href="/berita" class="hover:underline">Berita</a></li>

                        <li class="mb-2"><a href="/profil" class="hover:underline">Profil Desa</a></li>

                        <li class="mb-2"><a href="/kontak" class="hover:underline">Kontak Kami</a></li>

                        <li class="mb-2"><a href="/paket" class="hover:underline">Pemesanan</a></li>

                        <li class="mb-2"><a href="" class="hover:underline">Bahasa</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="text-gray-300 font-medium">
                        <li class="mb-4 flex gap-2 items-center">
                            ...
                            <p class="flex items-center">+62 877-8883-7494</p>
        ...
        <hr class="my-6 border-gray-200 h-[2px] bg-gray-200 sm:mx-autolg:my-8" />
