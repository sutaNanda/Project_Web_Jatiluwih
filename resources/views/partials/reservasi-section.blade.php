                    ...
                    <div class="bg-white rounded-xl px-4 shadow-sm mx-auto border-2 border-green-800 min-h-[400px] min-w-[350px] flex flex-col">
                        ...
                        <div class="p-5 flex-grow flex flex-col justify-between">
                            ...
                            <div class="flex justify-center mt-4">
                                <a href="" class="text-white bg-green-800 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                                    Lihat Paket
                                </a>
                            </div>
                        </div>
